package com.canaan.lockbible.Constants;

/**
 * Created by canaan on 2015/4/4 0004.
 */
public class Constants {
    ...
    public static final int FRAGMENT_VERSE_LIST = 0;
    public static final int FRAGMENT_PREFERENCE = 1;
